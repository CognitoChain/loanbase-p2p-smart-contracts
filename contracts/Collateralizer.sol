...
contract Collateralizer is Pausable, PermissionEvents {
        ...
        returns (bool _success)
    {
        ...
        */
        require(erc20token.allowance(collateralizer, address(tokenTransferProxy)) >= collateralAmount);
        ...
        emit CollateralLocked(agreementId, collateralToken, collateralAmount);
